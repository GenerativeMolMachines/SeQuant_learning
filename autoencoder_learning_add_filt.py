...
from autoencoder_filt import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_add_filt'
...
with open('trainHistoryDict/add_filt.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/add_filt.pkl', 'rb') as f:
