...
from autoencoder_deep import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_add_conv'
...
with open('trainHistoryDict/add_conv.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/add_conv.pkl', 'rb') as f:
