...
from autoencoder_11 import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_11'
...
with open('trainHistoryDict/11_trainHistoryDict' + str(num_seq) + '_maxlen' + str(max_len) + '_' + str(
