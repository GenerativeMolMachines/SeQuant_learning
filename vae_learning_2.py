...
with strategy.scope():
    ...
    x = layers.Conv2D(64, 3, activation="relu", strides=(2, 3), padding="same")(x)
    ...
    x = layers.Dense(2048, activation="relu")(x)
    x = BatchNormalization()(x)
    x = layers.Dense(5888, activation="relu")(x)
    x = BatchNormalization()(x)
    x = layers.Reshape((23, 4, 64))(x)
    x = layers.Conv2DTranspose(64, 3, activation="relu", strides=(2, 3), padding="same")(x)
