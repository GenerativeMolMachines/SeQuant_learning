...
with strategy.scope():
    ...
    x = layers.Conv2D(64, 3, activation="leaky_relu", strides=(1, 2), padding="same")(encoder_inputs)
    x = layers.Conv2D(32, 3, activation="leaky_relu", strides=(1, 4), padding="same")(x)
    x = layers.Conv2D(16, 3, activation="leaky_relu", strides=(2, 3), padding="same")(x)

    x = layers.Flatten()(x)
    x = layers.Dense(286, activation="leaky_relu")(x)
    ...
    x = layers.Conv2DTranspose(64, 3, activation="relu", strides=(1, 2), padding="same")(x)
