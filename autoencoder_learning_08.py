...
test_df = pd.read_csv('data/large_test_df.csv')
...
# Hyper parameters
learning_rate = 0.0028087
filter_strategy = '8_height'
...
# set checkpoint
checkpoint_filepath = f'checkpoint/checkpoint_08'
...
with open(f'trainHistoryDict/08.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open(f'trainHistoryDict/08.pkl', 'rb') as f:
