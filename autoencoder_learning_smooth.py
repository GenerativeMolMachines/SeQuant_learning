...
from autoencoder_smooth import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_smooth'
...
with open('trainHistoryDict/smooth.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/smooth.pkl', 'rb') as f:
