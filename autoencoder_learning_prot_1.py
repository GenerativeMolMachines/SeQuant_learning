...
from autoencoder_1 import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/cp_prot_arh_1'
...
with open('trainHistoryDict/th_prot_arh_1.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/th_prot_arh_1.pkl', 'rb') as f:
