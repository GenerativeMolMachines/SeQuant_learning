...
from autoencoder_10 import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_10'
...
with open('trainHistoryDict/10_trainHistoryDict' + str(num_seq) + '_maxlen' + str(max_len) + '_' + str(
