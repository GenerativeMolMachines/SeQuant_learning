...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_sample_batch'
...
with open('trainHistoryDict/sample_batch.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/sample_batch.pkl', 'rb') as f:
