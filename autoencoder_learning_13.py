...
from autoencoder_13 import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_13'
...
with open('trainHistoryDict/13_trainHistoryDict' + str(num_seq) + '_maxlen' + str(max_len) + '_' + str(
