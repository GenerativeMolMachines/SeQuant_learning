...
from autoencoder_sm_little import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_smooth_little'
...
with open('trainHistoryDict/smooth_little.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/smooth_little.pkl', 'rb') as f:
