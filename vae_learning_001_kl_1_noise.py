...
for strategy in filter_strategy:
    ...
    # set checkpoint
    checkpoint_filepath = f'checkpoint/checkpoint_vae_001_kl_1_noise'
    ...
    with open(f'trainHistoryDict/vae_001_kl_1_noise.pkl', 'wb') as file_pi:
        pickle.dump(history.history, file_pi)

    # load model learning history
    with open(f'trainHistoryDict/vae_001_kl_1_noise.pkl', 'rb') as f:
