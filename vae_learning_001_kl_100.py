...
from vae_001_kl_100 import autoencoder_model
...
for strategy in filter_strategy:
    ...
    # set checkpoint
    checkpoint_filepath = f'checkpoint/checkpoint_vae_001_kl_100'
    ...
    with open(f'trainHistoryDict/vae_001_kl_100.pkl', 'wb') as file_pi:
        pickle.dump(history.history, file_pi)

    # load model learning history
    with open(f'trainHistoryDict/vae_001_kl_100.pkl', 'rb') as f:
