...
for strategy in filter_strategy:
    ...
    # set checkpoint
    checkpoint_filepath = f'checkpoint/checkpoint_vae_007'
    ...
    with open(f'trainHistoryDict/vae_007.pkl', 'wb') as file_pi:
        pickle.dump(history.history, file_pi)

    # load model learning history
    with open(f'trainHistoryDict/vae_007.pkl', 'rb') as f:
