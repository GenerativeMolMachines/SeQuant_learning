...
dna_test_list = dna_test['sequence'].tolist()
assert np.all(
    seq_to_matrix(
...
X_train = np.concatenate(
    (dna_train_encoded_sequences, rna_train_encoded_sequences), axis=0)
X_train = preprocess_input(X_train)
X_test = np.concatenate(
    (dna_test_encoded_sequences, rna_test_encoded_sequences), axis=0)
