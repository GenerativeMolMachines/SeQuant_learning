...
from cae_001_noise import autoencoder_model
...
for strategy in filter_strategy:
    ...
    # set checkpoint
    checkpoint_filepath = f'checkpoint/checkpoint_cae_001_noise'
    ...
    with open(f'trainHistoryDict/cae_001_noise.pkl', 'wb') as file_pi:
        pickle.dump(history.history, file_pi)

    # load model learning history
    with open(f'trainHistoryDict/cae_001_noise.pkl', 'rb') as f:
...
"""
    ...
    embeddings_filepath = os.path.join(embeddings_dir, f'embeddings_full_{strategy}_1000.csv')
