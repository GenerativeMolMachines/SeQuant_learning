...
from ivae_001 import autoencoder_model
...
for strategy in filter_strategy:
    ...
    # set checkpoint
    checkpoint_filepath = f'checkpoint/checkpoint_ivae_001_kl_1_mmd_1'
    ...
    with open(f'trainHistoryDict/ivae_001_kl_1_mmd_1.pkl', 'wb') as file_pi:
        pickle.dump(history.history, file_pi)

    # load model learning history
    with open(f'trainHistoryDict/ivae_001_kl_1_mmd_1.pkl', 'rb') as f:
