...
from autoencoder_12 import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/checkpoint_12'
...
with open('trainHistoryDict/12_trainHistoryDict' + str(num_seq) + '_maxlen' + str(max_len) + '_' + str(
