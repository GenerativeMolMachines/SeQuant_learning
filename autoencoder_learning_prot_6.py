...
from autoencoder_6 import autoencoder_model
...
# set checkpoint
checkpoint_filepath = 'checkpoint/cp_prot_arh_6'
...
with open('trainHistoryDict/th_prot_arh_6.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open('trainHistoryDict/th_prot_arh_6.pkl', 'rb') as f:
