...
# set checkpoint
checkpoint_filepath = f'checkpoint/checkpoint_0{depth}'
...
with open(f'trainHistoryDict/0{depth}.pkl', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

# load model learning history
with open(f'trainHistoryDict/0{depth}.pkl', 'rb') as f:
